...
parser.add_argument('--test_csv_path', type=str, default='../SFNet_org/codes/data/PF_WILLOW/test_pairs_pf.csv', help='directory of test csv file')
parser.add_argument('--test_image_path', type=str, default='../SFNet_org/codes/data/PF_WILLOW/', help='directory of test data')
