...
parser.add_argument('--test_csv_path', type=str, default='../SFNet_org/codes/data/PF_Pascal/bbox_test_pairs_pf_pascal.csv', help='directory of test csv file')
parser.add_argument('--test_image_path', type=str, default='../SFNet_org/codes/data/PF_Pascal/', help='directory of test data')
